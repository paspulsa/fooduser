    ...
    try {
      ...
      if (payload && payload.id) {
        ...
        if (payload.role === 'GUEST') {
           ...
           tableId = (payload.table_id as string) || 'Bebas';
           userAddress = `Makan di Tempat (Meja: ${tableId})`;
           userPoints = 0; // Guest tidak punya poin
        } else {
  ...
  return c.render(
    <div class="bg-gray-100 dark:bg-gray-900 min-h-screen font-sans pb-28">
      ...
      <div class="max-w-md mx-auto bg-gray-50 dark:bg-gray-800 min-h-screen relative shadow-2xl overflow-x-hidden transition-colors duration-300">
        ...
        {/* ========================================================
            BLOK ALAMAT PENGANTARAN / INFO MEJA GUEST 
            ======================================================== */}
        <div class="p-4 mt-2">
          {isGuest ? (
             ...
             <div class="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-orange-100 dark:border-gray-700 flex items-start gap-3 relative overflow-hidden">
               ...
               <div class="flex-1">
                 <div class="flex justify-between items-center mb-1">
                   ...
                   <button onclick="detectGPSLocation()" class="text-[10px] font-bold text-[#ee4d2d] bg-orange-50 dark:bg-[#ee4d2d]/10 px-2 py-1.5 rounded-lg hover:bg-orange-100 transition-colors shadow-sm active:scale-95" id="btn-gps-refresh">
                     📍 Hitung Jarak
                   </button>
                 </div>
          ...
          <div class="px-4 mt-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 space-y-3 text-xs font-medium text-gray-600 dark:text-gray-400">
              ...
              <div class="flex justify-between border-b border-dashed border-gray-200 dark:border-gray-600 pb-3">
                <span id="summary-ongkir-label">Ongkos Kirim {isGuest ? '(Dine-In)' : ''}</span>
      ...
      <script dangerouslySetInnerHTML={{ __html: ' \
        ...
        function handleOrderTypeChange() { \
          ...
          if (type === "TAKEAWAY") { \
            ...
            isGpsDetected = false; \
            calculatedOngkir = deliverySettings.max_range_price || 10000; \
        ...
        function detectGPSLocation() { \
          ...
          if(navigator.geolocation) { \
            navigator.geolocation.getCurrentPosition( \
              (pos) => { \
                ...
                try { \
                  ...
                  calculateGrandTotal(); \
                  btn.innerText = "Hitung Ulang"; \
                  btn.disabled = false; \
                } catch(e) { \
                   showToast("Gagal menghitung jarak.", true); \
            ...
            showToast("GPS tidak didukung perangkat Anda.", true); \
            btn.innerText = originalText; btn.disabled = false; \
          } \
        } \
        \
        async function applyCoupon() { \
           ...
           try { \
             ...
             msgBox.innerText = "Gangguan jaringan."; \
             msgBox.className = "text-[11px] font-bold mt-2 text-red-500 block"; \
        ...
        function calculateGrandTotal() { \
          ...
          masterBtn.innerHTML = "<span class=\\"text-sm\\">Pesan & Bayar Sekarang</span><span class=\\"text-sm bg-white/20 px-3 py-1 rounded-lg\\">" + formatter.format(grandTotal) + "</span>"; \
        } \
        \
        async function processCheckout() { \
           ...
           if (!IS_GUEST) { orderType = document.getElementById("order-type").value; } \
           \
           ...
           try { \
             ...
             if (data.success) { \
               ...
               showToast("Pesanan berhasil dikirim ke dapur!"); \
